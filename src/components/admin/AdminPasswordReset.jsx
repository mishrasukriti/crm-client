...
const AdminPasswordReset = () => {
    ...
    const url = `https://sukriti-crm-server.herokuapp.com/api/admin/verifyPasswordChange`;
    const updatePasswordurl = `https://sukriti-crm-server.herokuapp.com/api/admin/updatePassword`;
