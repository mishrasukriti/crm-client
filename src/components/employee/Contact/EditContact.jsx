...
const EditLead = ({ id, Title, Client, Number, Email, Address }) => {
  ...
  useEffect(() => {
    ...
    const url =
      "https://sukriti-crm-server.herokuapp.com/api/employeedashboard/contact";
  ...
  const editContact = () => {
    ...
    axios
      .put(
        `https://sukriti-crm-server.herokuapp.com/api/employeedashboard/contact/${id}`,
        request
      )
      .then((res) => {
        successNotify();
                  ...
                  <div key={result._id} className="cards">
                    ...
                    <div className="button-container">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          history.push("/employeedashboard/contact")
                        }
                      >
                        Back
                        <i className="material-icons"> &#xe5c4;</i>
