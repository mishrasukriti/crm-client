...
const EditLead = ({ id, Title, Client, Number, Status }) => {
  ...
  useEffect(() => {
    ...
    const url =
      "https://sukriti-crm-server.herokuapp.com/api/employeedashboard/lead";
  ...
  const editLead = () => {
    ...
    console.log("sender mail in edit lead client is: "+ senderEmail);
    const request = {
      _id: id,
      title: title,
      client: client,
    ...
    axios
      .put(
        `https://sukriti-crm-server.herokuapp.com/api/employeedashboard/lead/${id}`,
        request
      )
      .then((res) => {
        successNotify();
