...
const EditService = ({
  ...
  useEffect(() => {
    ...
    const url =
      "https://sukriti-crm-server.herokuapp.com/api/managerdashboard/servicerequest";
  ...
  const editServiceRequest = () => {
    ...
    axios
      .put(
        `https://sukriti-crm-server.herokuapp.com/api/managerdashboard/servicerequest/${id}`,
        response
      )
      .then((res) => {
