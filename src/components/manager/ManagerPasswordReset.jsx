...
const ManagerPasswordReset = () => {
    ...
    const url = `https://sukriti-crm-server.herokuapp.com/api/manager/verifyPasswordChange`;
    const updatePasswordurl = `https://sukriti-crm-server.herokuapp.com/api/manager/updatePassword`;
